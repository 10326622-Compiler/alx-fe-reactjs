  ...
  const validate = () => {
    ...
    if (!formData.ingredients.trim()) {
      ...
      if (ingredientList.length < 2) {
        newErrors.ingredients = 'Please enter at least 2 ingredients (one per line or separated by commas)';
      }
    }
    ...
    if (!formData.steps.trim()) {
      ...
      newErrors.steps = 'Please provide more detailed preparation steps (at least 10 characters)';
    }
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="mb-6">
            ...
            <p className="mt-2 text-sm text-gray-500">
              💡 Tip: Enter each ingredient on a new line or separate with commas
            </p>
          </div>
          ...
          <div className="mt-6 p-4 bg-indigo-50 rounded-lg border border-indigo-100">
            <p className="text-sm text-indigo-800">
              ...
              Make sure to provide at least 2 ingredients and detailed preparation steps.
            </p>
          </div>
        </form>
      </div>
